<br>
<div style="text-align: center;"> <img src="img/image2.jpg"> </div>

<?php include_once './modules/comments/comment.php'; ?>


<?php
echo $view_comment_id;
echo $view_comment;
?>
<form name="comment" action="" method="post" style="padding-left: 20px; padding-top: 20px;">
    ...
    <p>
        <input type="hidden" name="page_id" value="galery" />
